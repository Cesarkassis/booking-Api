...
SECRET_KEY = 'django-insecure-i9ut%*0nx@(z7ta7)5uly(3xxjp(5d%172$rk5b0on6ch9f1_r'
...
MIDDLEWARE = [
    ...
    "bookings.middleware.RequestLoggingMiddleware",
]
...
# -------------------------
# Logging config: write to api.log
# -------------------------
